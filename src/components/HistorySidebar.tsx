...
export function HistorySidebar({ history, onSelect, activeId, isOpen, onToggle }: HistorySidebarProps) {
  return (
    <>
      ...
      {!isOpen && (
        <aside className="hidden md:flex w-12 flex-none border-r border-white/10 bg-[#080808] flex-col items-center py-4 z-20">
      ...
      {/* Expanded state */}
      <aside 
        className={`absolute md:relative inset-y-0 left-0 w-64 flex-none border-r border-white/10 bg-[#080808] flex flex-col z-30 transition-transform duration-300 ${
